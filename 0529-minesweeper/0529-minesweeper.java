class Solution {
    ...
    public static void reveal(int i,int j,char[][] board){
    ...
    public static int numbermines(int row,int col,char[][] board,int c){
        ...
        if (row - 1 >= 0 && col + 1 < board[0].length && board[row - 1][col + 1] == 'M') c++;
        if (row + 1 < board.length && col - 1 >= 0 && board[row + 1][col - 1] == 'M') c++;
        if (row + 1 < board.length && col + 1 < board[0].length && board[row + 1][col + 1] == 'M') c++;
        return c; 
    }
}